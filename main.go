...
import (
	...
	"citictel.com/vincentzou/vin-order/controllers"
...
func main() {
	if err := settings.Init(); err != nil {
		klog.Info("load config failed, err:%v\n", err)
		return
	}
	if err := mongodb.Init(settings.Conf.MongodbConfig); err != nil {
		klog.Info("init mongodb failed, err:%v\n", err)
		return
	}
	defer mongodb.Close()
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "959a4440.citictel.com",
